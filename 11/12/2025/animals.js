...
/*create a function that returns the number of animals that have a specific color, the function should 
be named "getAnimalsByColor", the function should receive only one parameter (the color the animal should 
have)
if the animal's color is: "White, Brown" and the color that we are searching is "Brown" the animal
} meets the color requirement.

if the animal's color is "Red-brown" and the color that we are searching is "red" the animal meets the 
color requirement.
