...
console.log(encontrarParejaEnLaCiudad({ nombre: "Camilo", edad: 23, intereses: ["Arte"], ciudad: "Medellín", genero: "Masculino" }));
...
console.log(encontrarParejasPotencialesPorEdad({ nombre: "Nicolás", edad: 23, intereses: ["Fotografía"], ciudad: "Medellín", genero: "Masculino" }));
