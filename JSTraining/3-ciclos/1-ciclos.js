...
console.log(saludoParseado);
 ...
 /*1.Definir en una variable el texto original.
   2.Definir otra variable para obtener los cambios, 
    es decir el resultado de lo que nos piden.
   3.Creamos el ciclo, esto para que itere sobre el texto original, es decir cuente caracter por caracter                                                                         a esa iteración debemos crearle un nombre para que nos ayude a 
    entender mejor el recorrido en este caso index
   4.Al index, le asignamos un valor de 0, y le decimos al ciclo que queremos 
    se ejecute hasta que el valor de iteración de index sea menor a la longitud
    del valor de la varibale "saludo" e incrementar  el valor de index a 1 para que impiece a iterar
   5. Se aplica una condición para reemplazar los espacios del valor de la variable saludo, entonces en este
   caso estamos diciendo "si el valor del index encuentra un espacio dentro del valor de la variable saludo
   entonces remplazar o asignar los espacios por un guion bajo a la variable saludoParseado
   y si no se cumple esta condición entonces a la variable saludoParseado le agregamos el valor de index de
   la variable saludo
   6. por ultimo imprimimos el resultado de nuestra lógica implementada en la variable saludoParseado*/
